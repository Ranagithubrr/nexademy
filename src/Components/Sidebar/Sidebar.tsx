...
const Sidebar = () => {
  ...
  return (
    <Card className="custom-scrollbar h-[calc(100vh-0rem)] overflow-x-hidden overflow-y-auto w-full max-w-[20rem] pl-2 shadow-xl shadow-blue-gray-900/5">
      <style>
        {`
          .custom-scrollbar {
            position: relative;
          ...
          .custom-scrollbar:hover::-webkit-scrollbar {
            width: 8px; /* Width of the scrollbar when hovered */
            height: 8px; /* Height for horizontal scrollbar when hovered */
          }
